...
@Entity
public class sRatings implements Serializable {
    ...
    public sRatings(Integer sRatingsid, Integer sCustomerid, Integer sStallStaffid, Integer ratingValue, String feedback) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof sRatings)) {
            return false;
        }
        sRatings other = (sRatings) object;
