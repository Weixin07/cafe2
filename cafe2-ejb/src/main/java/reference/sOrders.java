...
@Entity
public class sOrders implements Serializable {
    ...
    public sOrders(Integer sOrdersid, Integer sCustomerid, Integer sStallStaffid, String status, String paymentReferenceID) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof sOrders)) {
            return false;
        }
        sOrders other = (sOrders) object;
