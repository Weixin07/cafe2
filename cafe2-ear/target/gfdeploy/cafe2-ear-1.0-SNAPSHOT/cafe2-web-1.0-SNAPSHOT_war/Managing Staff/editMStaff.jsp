...
function populateFormFields(row) {
      ...
      const form = document.getElementById('editMStaffForm');

      // Populate form fields with cell values
      form.elements['ssUsername'].value = cells[0].textContent;
      form.elements['ssPassword'].value = cells[1].textContent;
    }

// Function to load the property data into the table
function loadMStaffTable() {
      fetch('LoadMStaffTable')
        .then(response => response.text())
        .then(data => {
          const propertyTableBody = document.getElementById('EditMStaffTableBody');
        ...
        .catch(error => {
          console.error('Error loading stall staff table:', error);
        });
...
window.addEventListener('DOMContentLoaded', loadMStaffTable);
...
<main>
  <div class="container">
    <form class="form-container" id="editMStaffForm" action="EditMStaff" method="POST">
        <h1>Edit MStaff</h1>
        <input type="text" name="msUsername" placeholder="Username">
        <br>
        <input type="password" name="msPassword" placeholder="Password">
        <br>
        <input type="submit" value="Edit MStaff">
        <br>
    ...
    <div class="property-listing">
      ...
      <table>
        ...
        <tbody id="EditMStaffTableBody"w>
