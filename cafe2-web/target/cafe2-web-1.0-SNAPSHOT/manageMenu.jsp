    ...
    <head>
        ...
        <script>
            function handleClick(quadrant) {
                switch (quadrant) {
                    case 'A':
                        window.location.href = "createMenu.jsp?uNameLabel2=" + encodeURIComponent(document.getElementById("uNameLabelText").textContent);
                        break;
                    case 'S':
                        window.location.href = "searchMenu.jsp?uNameLabel2=" + encodeURIComponent(document.getElementById("uNameLabelText").textContent);
                        break;
                    case 'E':
                        window.location.href = "editMenu.jsp?uNameLabel2=" + encodeURIComponent(document.getElementById("uNameLabelText").textContent);
                        break;
                    case 'D':
                        window.location.href = "deleteMenu.jsp?uNameLabel2=" + encodeURIComponent(document.getElementById("uNameLabelText").textContent);
                        break;
                }
            }
