...
<script>
    document.title = "Delete Managing Staff";
...
function populateFormFields(row) {
      ...
      const form = document.getElementById('deleteSMStaffForm');
...
function loadSMStaffTable() {
      fetch('LoadMStaffTable')
        .then(response => response.text())
        .then(data => {
          const propertyTableBody = document.getElementById('ViewMStaffTableBody');
        ...
        .catch(error => {
          console.error('Error loading Managing Staff table:', error);
        });
...
<main>
  <div class="container">
    <form class="form-container" id="deleteMStaffForm" action="DeleteMStaff" method="POST">
        <h1>Delete Managing Staff</h1>
        <input type="text" name="msUsername" placeholder="text" readonly>
        <br>
        <input type="submit" value="Delete Managing Staff">
        <br>
    ...
    <div class="property-listing">
      ...
      <table>
        ...
        <tbody id="ViewMStaffTableBody"w>
