...
function loadCustomerTable() {
      fetch('LoadCustomerTable')
        ...
        .then(data => {
          const propertyTableBody = document.getElementById('ViewCustomerTableBody');
...
<main>
  <div class="container">
    <form class="form-container" id="deleteCustomerForm" action="DeleteCustomer" method="POST">
        <h1>Delete Customer</h1>
        <input type="email" name="cEmail" placeholder="Email" readonly>
        <br>
    ...
    <div class="property-listing">
      ...
      <table>
        ...
        <tbody id="ViewCustomerTableBody"w>
