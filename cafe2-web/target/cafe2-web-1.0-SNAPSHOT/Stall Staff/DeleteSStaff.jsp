...
<script>
    document.title = "Delete Stall Staff";
...
function loadSStaffTable() {
      fetch('LoadSStaffTable')
        ...
        .then(data => {
          const propertyTableBody = document.getElementById('ViewSStaffTableBody');
...
<main>
  <div class="container">
    <form class="form-container" id="editStaffForm" action="DeleteStaff" method="POST">
        <h1>Delete Stall Staff</h1>
        <input type="text" name="ssUsername" placeholder="Username" readonly>
        <br>
        <input type="submit" value="Delete Stall Staff">
        <br>
