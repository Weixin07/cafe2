...
function populateFormFields(row) {
      ...
      const form = document.getElementById('editSStaffForm');
...
function loadSStaffTable() {
      fetch('LoadSStaffTable')
        ...
        .then(data => {
          const propertyTableBody = document.getElementById('EditSStaffTableBody');
...
<main>
  <div class="container">
    <form class="form-container" id="editSStaffForm" action="EditSStaff" method="POST">
        <h1>Edit SStaff</h1>
        <input type="text" name="ssUsername" placeholder="Username">
        <br>
        <input type="password" name="ssPassword" placeholder="Password">
        <br>
        <input type="submit" value="Edit SStaff">
        <br>
    ...
    <div class="property-listing">
      ...
      <table>
        ...
        <tbody id="EditSStaffTableBody"w>
