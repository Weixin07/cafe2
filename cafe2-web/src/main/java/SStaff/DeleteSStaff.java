...
@WebServlet(name = "DeleteSStaff", urlPatterns = {"/DeleteSStaff"})
public class DeleteSStaff extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                request.getRequestDispatcher("deleteSStaff.jsp").include(request, response);
